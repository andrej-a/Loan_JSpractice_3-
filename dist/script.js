...
window.addEventListener("DOMContentLoaded", function () {
  ...
  showUpSlider.init();
  var modulesUpSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_2__["default"]({
...
/* harmony import */ var _service_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../service/service */ "./src/js/service/service.js");
...
function () {
  ...
  _createClass(Forms, [{
    key: "setCursorEnd",
    value: function setCursorEnd(elem) {
    ...
    value: function phoneMask() {
      var matrix = "+1 (___) ___-____"; //создаем матрицу. можно из БД или сервера
    ...
    key: "checkLanguages",
    value: function checkLanguages(array) {
...
function (_Slider) {
  ...
  function MiniSlider(container, next, prev, timeMS, activeClass, animate, autoplay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, next, prev, timeMS, activeClass, animate, autoplay));
  }

  _createClass(MiniSlider, [{
    key: "decorizeActiveItem",
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$timeMS = _ref.timeMS,
      timeMS = _ref$timeMS === void 0 ? null : _ref$timeMS,
...
/*!***********************************!*\
  !*** ./src/js/service/service.js ***!
  \***********************************/
/*! exports provided: postDataFormToServer */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
